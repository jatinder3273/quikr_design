...
/***********************  TOP Bar ********************/
.sidebar{ width:400px; position:fixed; background-color:rgb(240, 238, 238);transition: all 0.5s  ease-in-out; }
.bg-defoult{background-color:rgb(252, 249, 249);}
.sidebar ul{ list-style:none;overflow-y:auto; height:100vh;margin:0px; padding:0px; }
.sidebar li a,.sidebar li a.collapsed.active{ display:block; padding:8px 12px; color:rgb(141, 137, 137);border-left:0px solid #cfc9c9;  text-decoration:none}
.sidebar li a.active{background-color:rgb(237, 243, 238);border-left:5px solid #dedede; transition: all 0.5s  ease-in-out}
.sidebar li a:hover{background-color:rgb(72, 202, 3) !important;}
...
<body class="hold-transition sidebar-mini layout-fixed" >
    <div class="container">
        <div class="wrapper">
            ...
            <!-- /.navbar -->
            @include('Front.QuickrProduct.quikrlayout.Partials.topnav')
            <!-- /.navbar -->
