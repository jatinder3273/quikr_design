                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="text-right" style="float:right;">
                                <form method="get" action="model" id="search" class="form-inline my-2 my-lg-0">
                                    @csrf
                                    ...
                                    <a href="/model/create" class="btn btn-primary" id="add">
                                        <center>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody class="list">
                                    <tr>
                                        ...
                                        <td>{{$data->name}}</td>
                                        <td>{{$data->brand_name->name}}</td>

                                        <td>
                                        <div class ="buttons">
                                            <a>
                                                <a href="{{ URL::to('model/' . $data->id . '/edit') }}"
                                                ...
                                                <form action="{{ route('model.destroy', $data->id) }}"
                                                    method="POST">
