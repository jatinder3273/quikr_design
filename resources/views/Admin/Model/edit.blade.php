                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{ route('model.update', $data->id) }}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Brand</label>
                                    <select class="form-control" name="brand_id" data-placeholder="Select a State"
                                        style="width: 100%;">
                                        @foreach($brand as $brandname)

                                        <option value="{{ old('id') ?? $brandname->id}}" <option
                                            value="{{ old('id') ?? $brandname->id}}" @if($brandname->id ==
                                            $data->brand_id)
                                            {{'selected="selected"'}}
                                            @endif >
