                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Brand Management System</h3>
                            <div class="text-right" style="float:right;">
                                <form method="get" action="brand" id="search" class="form-inline my-2 my-lg-0">
                                    @csrf
                                    ...
                                    <a href="/brand/create" class="btn btn-primary" id="add">
                                        <center>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody class="list">
                                    <tr>
                                        ...
                                        <div class ="buttons">
                                            <a>
                                                <a href="{{ URL::to('brand/' . $data->id . '/edit') }}"
                                                ...
                                                <form action="{{ route('brand.destroy', $data->id) }}"
                                                    method="POST">
