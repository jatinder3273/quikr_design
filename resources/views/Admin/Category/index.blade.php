                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Categories Management System</h3>
                            <div class="text-right" style="float:right;">
                                <form method="get" action="category" id="search" class="form-inline my-2 my-lg-0">
                                    @csrf
                                    ...
                                    <a href="/category/create" class="btn btn-primary" id="add">
                                        <center>
                                ...
                                <tbody class="list">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="buttons">
                                                <a>
                                                    <a href="{{ URL::to('category/' . $categories->id . '/edit') }}"
                                                    ...
                                                    <form action="{{ route('category.destroy', $categories->id) }}"
                                                        ...
                                                        <button class="btn btn-danger minus"
                                                            style="height:40px;width:40px; margin-top:0;"><i
                                                                class="fa fa-trash" aria-hidden="true"></i></button>
                                                    </form>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a href="{{ URL::to('category/' . $categories->id) }}"
                                                        class="btn btn-primary btn-sm" style="height:40px;width:40px;">
